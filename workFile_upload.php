...
// echo "<div style='text-align:right;padding:2px;'><span onclick=\"closeDiv()\" style='cursor:pointer;'>X close</span></div>";
	echo "<div style='color:#FFFFFF'>";
        ...
        //echo "<input type='file' name='image_uploads' id='nowFile'  accept='image/*'></label>";
		//echo "<input type=\"file\" id=\"image_uploads\" name=\"image_uploads\" accept=\".jpg, .jpeg, .png\" style=\"position:absolute;height:320px;width:480px;\">";
